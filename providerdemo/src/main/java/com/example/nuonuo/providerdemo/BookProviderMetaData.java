...
public class BookProviderMetaData {
    public static final String AUTHORITY = "com.example.nuonuo.providerdemo.BookProvider";
    ...
    public static final class BookTableMetaData implements BaseColumns {
        ...
        public static final String CREATED_DATE  = "created"; //创建日期
        //Integer from System.currentTimeMillis()
        public static final String MODIFIED_DATE = "modified"; //最后更新日期
    }
}
